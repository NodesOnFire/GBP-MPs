...
int main(int argc, char **argv) {
    ...
    while(low <= high){
        ...
        try{
            ...
            s.resize(n, vector<GRBVar>(ceil(log2(g))));
            for(int i=0;i<n;i++){
                for(int j=0;j<ceil(log2(g));j++){
            ...
            for(int j=0;j<g;j++){
                ...
                objective_function += 1 - expr1 + 2 * expr2;
            }
            ...
            for(int i=0;i<n;i++){
                ...
                GRBQuadExpr expr3 = (1 - expr1 + expr2)*(1 - expr1 + expr2);
                objective_function += expr3;
            }
